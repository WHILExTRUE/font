...
.toolbar-3_r2xA [name=Nova_BellOff].icon-2xnN2Y > path, .toolbar-3_r2xA [name=Nova_Pin].icon-2xnN2Y > g,
...
.containerDefault-YUSmu3 .wrapper-NhbLHG.modeSelected-3DmyhH .content-1gYQeQ .name-28HaxV {
  color: var(--channel-text-selected);
}
...
.privateChannels-1nO12o .channel-2QD9_O.selected-1-Z6gm .layout-1qmrhw:before {
  background: rgba(255, 255, 255, 0.1);
}
...
/* MENTIONS */
.topic-11NuQZ .wrapper-3WhCwL,
.topic-11NuQZ .mention,
.markup-eYLPri .wrapper-3WhCwL,
.markup-eYLPri .mention {
  padding: 0 4px;
  border-radius: 5px;
  line-height: 22px;
  font-weight: 500;
...
.topic-11NuQZ .wrapper-3WhCwL:hover,
.markup-eYLPri .wrapper-3WhCwL:hover {
  background-color: var(--main-color);
  color: #fff;
}
.topic-11NuQZ strong > .wrapper-3WhCwL,
.topic-11NuQZ strong > .mention,
.markup-eYLPri strong > .wrapper-3WhCwL,
.markup-eYLPri strong > .mention {
  font-weight: 600;
}
...
.markup-eYLPri .spoilerText-3p6IlD {
  padding: 1px 4px;
}
...
.members-3WRCEx .member-2gU6Ar [style*="color:"].roleColor-nA7BqX:before, .members-3WRCEx .member-2gU6Ar [style*="color:"].roleColor-nA7BqX:after {
  background: linear-gradient(to right, currentColor 90%, transparent);
}
.members-3WRCEx .member-2gU6Ar:hover .roleColor-nA7BqX:before, .members-3WRCEx .member-2gU6Ar.selected-1-Z6gm .roleColor-nA7BqX:before {
  opacity: 1;
}
.members-3WRCEx .member-2gU6Ar:hover [style*="color:"].roleColor-nA7BqX:before, .members-3WRCEx .member-2gU6Ar.selected-1-Z6gm [style*="color:"].roleColor-nA7BqX:before {
  opacity: 0.07;
}
...
.members-3WRCEx .memberGroupsPlaceholder-3mwPub {
  margin: 0 25%;
  display: flex;
  align-items: center;
  justify-content: center;
...
.members-3WRCEx .memberGroupsPlaceholder-3mwPub:before, .members-3WRCEx .memberGroupsPlaceholder-3mwPub:after {
  content: "";
  height: 2px;
  flex-grow: 1;
}
.members-3WRCEx .memberGroupsPlaceholder-3mwPub:before {
  background: linear-gradient(to left, currentColor 50%, transparent);
  margin-right: calc(50% + 5px);
  margin-left: -50%;
}
.members-3WRCEx .memberGroupsPlaceholder-3mwPub:after {
  background: linear-gradient(to right, currentColor 50%, transparent);
  margin-right: -50%;
  margin-left: calc(50% + 5px);
}
.members-3WRCEx .memberGroupsPlaceholder-3mwPub,
.members-3WRCEx .placeholderAvatar-damqh6,
.members-3WRCEx .placeholderUsername-2B_OA9,
.members-3WRCEx .mulitplePlaceholderUsername-pogq9I {
...
/* SEARCH */
.content-1jQy2l .searchResultsWrap-3-pOjs {
  background-color: rgba(0, 0, 0, 0.6);
}
...
/* GAME LIBRARY */
.base-2jDfDU .gameLibrary-TTDw4Y,
.base-2jDfDU .root-1BQpZw {
  background-color: transparent;
}
...
/* STORE */
.base-2jDfDU .applicationStore-1pNvnv {
  background: transparent;
}
...
.applicationStore-1pNvnv .scrollerBase-_bVAAt {
  background-color: transparent;
}
...
.appMount-2yBXZl .lookFilled-1Gx00P.colorBrandNew-g5lmBU,
.appMount-2yBXZl .lookFilled-1Gx00P.colorPrimary-3b3xI6 {
  background: var(--main-color);
  color: #fff;
}
...
.appMount-2yBXZl .lookFilled-1Gx00P.colorBrandNew-g5lmBU:hover,
.appMount-2yBXZl .lookFilled-1Gx00P.colorPrimary-3b3xI6:hover {
  background: var(--hover-color);
}
...
.appMount-2yBXZl .lookFilled-1Gx00P.colorBrandNew-g5lmBU:disabled,
.appMount-2yBXZl .lookFilled-1Gx00P.colorPrimary-3b3xI6:disabled {
  background: var(--main-color) !important;
}
...
.appMount-2yBXZl .lookFilled-1Gx00P.colorBrandNew-g5lmBU:active,
.appMount-2yBXZl .lookFilled-1Gx00P.colorPrimary-3b3xI6:active {
  background: var(--main-color);
}
...
.appMount-2yBXZl .lookOutlined-3sRXeN.colorPrimary-3b3xI6,
.appMount-2yBXZl .lookOutlined-3sRXeN.colorGreen-29iAKY,
.appMount-2yBXZl .lookOutlined-3sRXeN.colorBrand-3pXr91 {
  background: transparent;
  border-color: var(--main-color);
  color: rgba(255, 255, 255, 0.8);
}
.appMount-2yBXZl .lookOutlined-3sRXeN.colorWhite-rEQuAQ:hover,
.appMount-2yBXZl .lookOutlined-3sRXeN.colorPrimary-3b3xI6:hover,
.appMount-2yBXZl .lookOutlined-3sRXeN.colorGreen-29iAKY:hover,
.appMount-2yBXZl .lookOutlined-3sRXeN.colorBrand-3pXr91:hover {
  background: transparent;
  border-color: var(--hover-color);
  color: #fff;
}

.appMount-2yBXZl .lookOutlined-3sRXeN.colorRed-1TFJan {
  background: transparent;
  border-color: var(--danger-color);
  color: rgba(255, 255, 255, 0.8);
}
.appMount-2yBXZl .lookOutlined-3sRXeN.colorRed-1TFJan:hover {
  background: transparent;
  border-color: var(--hover-color);
  color: #fff;
}
...
.modeSelected-3DmyhH .textBadge-1iylP6,
.selected-1-Z6gm .numberBadge-37OJ3S,
.selected-1-Z6gm .textBadge-1iylP6,
.selected-3s45Ha .numberBadge-37OJ3S,
...
.wanderingCubesItem-3Us-UG:before, .wanderingCubesItem-3Us-UG:after {
  content: "";
  position: absolute;
  top: 0;
  right: 0;
...
.container-1oeRFJ .subText-OGOWMj > strong, .container-1oeRFJ .activityText-1rR-8O > strong {
  color: var(--main-color);
  font-weight: 700;
  transition: all 0.15s ease-in-out;
}
...
.container-1oeRFJ.selected-1-Z6gm .subText-OGOWMj > strong, .container-1oeRFJ.selected-1-Z6gm .activityText-1rR-8O > strong {
  color: #fff;
}
...
*/
/* GROUP INVITE POPOUT */
.theme-dark .popout-103y-5.root-g14mjS {
  background-color: rgba(0, 0, 0, 0.8);
}
...
.theme-dark .header-145e10 .tabBar-1qdMr5 .tab-TRrPC8 {
  color: #fff;
}
.theme-dark .header-145e10 .tabBar-1qdMr5 .tab-TRrPC8.active-1MbGPa {
  background-color: var(--main-color);
}
.theme-dark .header-145e10 .tabBar-1qdMr5 .tab-TRrPC8:hover:not(.active-1MbGPa) {
...
.jumpButton-1ITAeq .text-3KVtey {
  color: #fff;
}
.jumpButton-1ITAeq:hover {
  background-color: var(--hover-color);
}
.jumpButton-1ITAeq:hover .text-3KVtey {
  color: #fff;
}
...
.theme-dark .modal-2VIBV8 .footer-31IekZ, .theme-dark .modal-2VIBV8 .modal-f02hVt, .theme-dark .modal-2VIBV8 .formFieldWrapper-malor5, .theme-dark .modal-2VIBV8 .guildSidebar-2OCzWB, .theme-dark .modal-2VIBV8 .settingsFormFieldWrapper-3Y77Pr,
.theme-dark .root-g14mjS .footer-31IekZ,
.theme-dark .root-g14mjS .modal-f02hVt,
.theme-dark .root-g14mjS .formFieldWrapper-malor5,
.theme-dark .root-g14mjS .guildSidebar-2OCzWB,
.theme-dark .root-g14mjS .settingsFormFieldWrapper-3Y77Pr {
  background: transparent;
  box-shadow: none;
}
...
.tabBar-2hXqzU > .item-PXvHYJ + .item-PXvHYJ {
  margin-left: 20px;
}
.tabBar-2hXqzU > .item-PXvHYJ:before {
  content: "";
  position: absolute;
  top: 0;
  right: 0;
...
.tabBar-2hXqzU > .item-PXvHYJ:after {
  content: "";
  position: absolute;
  top: 100%;
  right: 0;
...
.tabBar-2hXqzU > .item-PXvHYJ:hover:before, .tabBar-2hXqzU > [style*="color: rgb(255, 255, 255)"].item-PXvHYJ:before {
  opacity: 1;
}
.tabBar-2hXqzU > .item-PXvHYJ:hover {
  color: rgba(255, 255, 255, 0.7) !important;
}
.tabBar-2hXqzU > .item-PXvHYJ.selected-3s45Ha, .tabBar-2hXqzU > [style*="color: rgb(255, 255, 255)"].item-PXvHYJ {
  color: #fff !important;
}
.tabBar-2hXqzU > .item-PXvHYJ.selected-3s45Ha:after, .tabBar-2hXqzU > [style*="color: rgb(255, 255, 255)"].item-PXvHYJ:after {
  top: 0;
  -webkit-animation: cv-slide-top 0.2s ease-in-out;
          animation: cv-slide-top 0.2s ease-in-out;
}
.tabBar-2hXqzU > .item-PXvHYJ.selected-3s45Ha:before, .tabBar-2hXqzU > [style*="color: rgb(255, 255, 255)"].item-PXvHYJ:before {
  bottom: 100%;
  animation: cv-slide-bottom 0.2s ease-in-out reverse;
}
...
.body-1Ukv50 .userInfoSection-2u2hir > .note-3M15gE > textarea::-moz-placeholder {
  color: rgba(255, 255, 255, 0.5);
}
.body-1Ukv50 .userInfoSection-2u2hir > .note-3M15gE > textarea:-ms-input-placeholder {
  color: rgba(255, 255, 255, 0.5);
}
...
.connectedAccounts-1YaT2t > .connectedAccount-1xKpli:hover .connectedAccountOpenIcon-1yfBsb {
  opacity: 0.7;
}
...
.connectedAccountVerifiedIcon-3XCxT8 .flowerStar-1GeTsn {
  opacity: 0;
}
.connectedAccountVerifiedIcon-3XCxT8 .childContainer-1wxZNh {
  display: none;
}
...
.theme-dark .item-3T2z1R:hover {
  background-color: var(--hover-color);
}

.selectorButtonSelected-Jj5-3m {
  background-color: var(--main-color);
}
...
[aria-label=USER_SETTINGS] .sidebar-CFHs9e [aria-controls=profile-customization-tab].item-PXvHYJ:before {
...
[aria-label=USER_SETTINGS] .sidebar-CFHs9e [aria-controls=subscriptions-tab].item-PXvHYJ:before {
...
[aria-label=USER_SETTINGS] .sidebar-CFHs9e [aria-controls=accessibility-tab].item-PXvHYJ:before {
...
.descriptionBox-2ypBKO {
  background-color: rgba(0, 0, 0, 0.4);
}

.upsellContainer-1G_YVf, .upsellContent--qqwsl, .upsellFooter-LSx-FB {
  background-color: transparent;
}
...
.developerPortalCtaWrapper-Pxhnc3 {
  background-color: transparent;
}
...
.checklistContainer-euvGxh {
  background-color: rgba(0, 0, 0, 0.4);
}
.checklistContainer-euvGxh .checklistHeader-TtQAoo {
  background-color: rgba(0, 0, 0, 0.4);
}
.checklistContainer-euvGxh .separator-Hx_3SF {
  background-color: rgba(255, 255, 255, 0.06);
  opacity: 1;
}
...
.checklist-Q2wuVY .header-18YAsG {
  background-color: rgba(0, 0, 0, 0.4);
}
.checklist-Q2wuVY .separator-1M0Hlx {
  background-color: rgba(255, 255, 255, 0.06);
}

.card-3RzMcx, .emptyChannelIcon-1YdEz2 {
  background-color: var(--background-overlay);
}
...
/* SERVER DISCOVER */
.base-2jDfDU .pageWrapper-1PgVDX {
  background: rgba(0, 0, 0, calc(var(--background-shading) * .5));
}
...
.guildList-3cJX3d .spinner-2RT7ZC {
  background-color: rgba(0, 0, 0, 0.8);
}
...
/* SERVER BOOST */
.theme-dark .perksModal-12XaFK {
  background-color: transparent;
}
.theme-dark .ctaBar-AS95ST {
  background-color: rgba(0, 0, 0, 0.4);
}
.theme-dark .ctaBar-AS95ST .guildIcon-3kPJme {
  background-color: transparent;
}
.theme-dark .ctaBar-AS95ST .badgeIconWithoutSubscribers-XDrfue {
  color: #fff;
  opacity: 0.8;
}
.theme-dark .ctaBar-AS95ST .giftIcon-ux_SI2 {
  color: currentColor;
}
...
.theme-dark .tierBody-24neog,
.theme-dark .tierHeaderLocked-AmFepj,
.theme-dark .perk-3ia9RN {
  background-color: rgba(0, 0, 0, 0.4);
}
.theme-dark .tierHeaderLocked-AmFepj {
  color: rgba(255, 255, 255, 0.7);
}
.theme-dark .tierLock-WKTTrK {
  color: #fff;
  opacity: 0.3;
}

.theme-dark .wrapper-3qSb0d {
  background-color: rgba(0, 0, 0, calc(var(--background-shading) * .5));
}
...
.progressBarTrack-3y6rh7,
.progressBarMarker-1PPOYV {
  background-color: rgba(0, 0, 0, 0.6);
}

.progressBarMarkerNextTier-EG5a7t .progressBarMarkerIndicator-15WiF7 {
  background-image: none;
  box-shadow: 0 0 2px 2px var(--main-color);
}
.progressBarMarkerNextTier-EG5a7t .progressBarMarkerIndicator-15WiF7:after {
  background-color: transparent;
}

.progressBarMarkerNumSubscriptionsRequired-3wj3cy {
  color: #fff;
}

.progressBarMarkerUnlocked-3IgZ-5 .progressBarMarkerIndicator-15WiF7,
.progressBarFill-T4kMVn {
  background-image: none;
  background-color: var(--main-color);
}
...
.theme-dark .perksTableRow-7kHR8w + .perksTableRowBody-3adE9w:hover,
.theme-dark .perksTableRow-7kHR8w + .perksTableRowFocused-37qPHa {
  background-color: rgba(255, 255, 255, 0.05);
  border-top: rgba(255, 255, 255, 0.07);
}
.theme-dark .perksTableRow-7kHR8w + .perksTableRowBody-3adE9w:hover + .perksTableRowBody-3adE9w,
.theme-dark .perksTableRow-7kHR8w + .perksTableRowFocused-37qPHa + .perksTableRowBody-3adE9w {
  border-top: rgba(255, 255, 255, 0.07);
}
.theme-dark .perksTableRow-7kHR8w + .perksTableRowBody-3adE9w:hover .perksTableRowPerkHighlighted-3bmp8T,
.theme-dark .perksTableRow-7kHR8w + .perksTableRowFocused-37qPHa .perksTableRowPerkHighlighted-3bmp8T {
  background-color: rgba(255, 255, 255, 0.05);
  border-color: rgba(255, 255, 255, 0.07);
}

.perksTableRowPerkHighlighted-3bmp8T,
.perksTableHighlightedColumnHeader-CkjCDK,
.perksTableRow-7kHR8w:last-child .perksTableRowPerkHighlighted-3bmp8T:after {
  background-color: rgba(255, 255, 255, 0.05);
}
...
.perksTableHighlightedColumnHeaderCopy-vcrleo {
  background-image: none;
  background-color: var(--main-color);
}
...
.members-3WRCEx > #MemberCount:before, .members-3WRCEx > #MemberCount:after {
  display: none;
}
